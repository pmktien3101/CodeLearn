  ...
  rows: [
    {
      ...
      action: (
        <Link to="/teaching/course-infor/1">
          <SoftBadge variant="gradient" badgeContent="View" color="grey" size="xs" container />
        </Link>
      ),
    },
    {
      ...
      action: (
        <Link to="/teaching/course-infor/2">
          <SoftBadge variant="gradient" badgeContent="View" color="grey" size="xs" container />
        </Link>
      ),
    },
    {
      ...
      action: (
        <Link to="/teaching/course-infor/3">
          <SoftBadge variant="gradient" badgeContent="View" color="grey" size="xs" container />
        </Link>
      ),
    },
