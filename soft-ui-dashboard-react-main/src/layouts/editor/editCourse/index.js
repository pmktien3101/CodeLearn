            ...
            <Grid item xs={12} lg={11}> {/* Adjusted width */}
              <SoftBox p={3}>
                ...
                <Card variant="outlined" sx={{ mb: 3 }}>
                  <CardContent>
                    <Grid container spacing={2} direction="column">
                      ...
                      <Grid item xs={12} display="flex" alignItems="center">
                        <TextField label="Instructor" variant="outlined" fullWidth />
                        <IconButton aria-label="edit">
                          <EditIcon />
                        </IconButton>
                      </Grid>
                ...
                <Card variant="outlined">
                  <CardContent>
                    <SoftTypography variant="h5" mb={2}>Topic List</SoftTypography>
                    <Grid container spacing={2}>
                      {topics.map((topic) => (
                        <Grid item xs={12} key={topic.id} display="flex" alignItems="center">
                          <Card variant="outlined" sx={{ flexGrow: 1 }}>
                            <CardContent>
                              <SoftTypography variant="body1"><strong>Topic:</strong> {topic.name}</SoftTypography>
                            </CardContent>
                          </Card>
                          <Link to={`/editor/EditTopic/${topic.id}`}>
                            <IconButton aria-label="edit">
                              <EditIcon />
                            </IconButton>
                          </Link>
